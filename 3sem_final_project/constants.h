...
Есть и более длинные слова, особенно много их в химии (т.к. там многосоставные названия). Но таких слов очень мало и запоминать их нет смысла.
...
// Число символов, не требующих после себя пробела перед следующим словом
#define NOT_DEMANDING_SPACE 16
