...
void print_help()
{
    ...
    printf("ОБРАТИТЕ ВНИМАНИЕ, ЧТО ТЕКСТЫ И МОДЕЛИ, СОДЕРЖАЩИЕ РУССКИЕ СЛОВА, ДОЛЖНЫ ИМЕТЬ КОДИРОВКУ ANSI. Это касается и файлов с конфигурацией.\n");
    printf("Для английских слов допостима кодировка UTF - 8\n");
