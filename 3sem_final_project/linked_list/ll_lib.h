...
// Вернуть указатель на узел связного списка по его индексу
...
// Вернуть индекс первого элемента, для данных data которого функция predicate с параметрами extra_data возвращает истину; 
